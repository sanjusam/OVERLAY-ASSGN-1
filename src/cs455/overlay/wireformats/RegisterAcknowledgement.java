...
public class RegisterAcknowledgement extends AbstractEvent {
    private byte code;
    ...
    public RegisterAcknowledgement(final byte code , final String additionalInfo) {
    ...
    public RegisterAcknowledgement(byte[] marshalledBytes) throws IOException {
