...
public class SendLinkWeightsEvent extends AbstractEvent {
    ...
    public SendLinkWeightsEvent(final int numLinks) {
    ...
    public SendLinkWeightsEvent(byte[] marshalledBytes) throws IOException {
