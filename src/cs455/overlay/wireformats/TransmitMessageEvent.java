...
public class TransmitMessageEvent extends AbstractEvent {
    private final int messageContent;
    private final String destination;

    public TransmitMessageEvent(final int messageContent, final String destination) {
    ...
    public TransmitMessageEvent(byte[] marshalledBytes) throws IOException {
